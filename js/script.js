{
  ...
  / 7.2-7.3 customSelector ma znaczenie przy filtrowaniu/
    ...
    for (let article of articles) {
      ...
      for (let tag of articleTagsArray) {
        ...
        if (!allTags[tag]) {
          ...
          // 1, jesli w obiekcie allTags nie ma jeszcze danego tagu
          allTags[tag] = 1;
          // ++ to operator inkrementacji, zwiekszaja liczbe o 1, jest to dla sytuacji, jesli ten tag wystepuje juz w allTags
        } else {
          allTags[tag]++;
        }
